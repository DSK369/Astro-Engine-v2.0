...
export const UI_STRINGS = {
  en: {
    ...
    langToggle: "हिन्दी",
    transitTimelineLink: "Transit Timeline ↗",
    ...
    modeNatal: "Birth Chart",
    modeHorary: "KP Horary (Prasna)",
    sectionHoraryDetails: "Horary Details",
    horaryFormLegend: "Horary Question",
    horaryNumber: "Horary Number",
    horaryNumberHint: "1–249",
    horaryDate: "Date to Search",
    horaryFormSubmit: "Find Horary Chart",
    horaryErrorNumber: "Enter a horary number between 1 and 249 — pick it per KP Horary tradition (e.g. asked of the querent), don't just guess one.",
    horaryMatchedMoment: "Matched Moment",
    horaryZoneSign: "Zone Sign",
    horaryZoneNakshatra: "Zone Nakshatra",
    horaryZoneSubLord: "Zone Sub-Lord",
    horaryZoneRange: "Zone Range",
    ...
    calendarAmantaMonth: "Lunar Month (Amanta)",
    calendarPurnimantaMonth: "Lunar Month (Purnimanta)",
    calendarSolarMonth: "Solar Month",
    calendarRitu: "Ritu (Season)",
    calendarAyana: "Ayana",
    calendarNextSankranti: "Next Sankranti",
    calendarAdhika: "Adhika",
    ritu_Vasanta: "Vasanta (Spring)",
    ritu_Grishma: "Grishma (Summer)",
    ritu_Varsha: "Varsha (Monsoon)",
    ritu_Sharad: "Sharad (Autumn)",
    ritu_Hemant: "Hemant (Pre-winter)",
    ritu_Shishira: "Shishira (Winter)",
  ...
  hi: {
    ...
    langToggle: "English",
    transitTimelineLink: "गोचर समयरेखा ↗",
    ...
    modeNatal: "जन्म कुंडली",
    modeHorary: "के.पी. प्रश्न (होररी)",
    sectionHoraryDetails: "प्रश्न विवरण",
    horaryFormLegend: "प्रश्न (होररी)",
    horaryNumber: "होररी संख्या",
    horaryNumberHint: "1–249",
    horaryDate: "खोजने की तिथि",
    horaryFormSubmit: "प्रश्न कुंडली खोजें",
    horaryErrorNumber: "1 से 249 के बीच होररी संख्या दर्ज करें — के.पी. होररी परंपरा के अनुसार चुनें (जैसे प्रश्नकर्ता से पूछकर), अनुमान न लगाएं।",
    horaryMatchedMoment: "मिलान क्षण",
    horaryZoneSign: "क्षेत्र राशि",
    horaryZoneNakshatra: "क्षेत्र नक्षत्र",
    horaryZoneSubLord: "क्षेत्र उप-स्वामी",
    horaryZoneRange: "क्षेत्र सीमा",
    ...
    sectionCalendar: "पंचांग कैलेंडर",
    calendarAmantaMonth: "चंद्र मास (अमांत)",
    calendarPurnimantaMonth: "चंद्र मास (पूर्णिमांत)",
    calendarSolarMonth: "सौर मास",
    calendarRitu: "ऋतु",
    calendarAyana: "अयन",
    calendarNextSankranti: "अगली संक्रांति",
    calendarAdhika: "अधिक",
    ritu_Vasanta: "वसंत",
